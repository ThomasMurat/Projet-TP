                    ...
                    <nav class="navbar float-left col-3 col-lg-2 justify-content-center" id="userMenu">
                        ...
                        <div class="collapse navbar-collapse" id="userMenuContent">
                            <ul id="userMenuList" class="navbar-nav">
                                <li class="nav-item d-flex"><a class="text-white text-center w-100" href="MU-subscrib.html">S'inscrire</a></li>
                                <li class="nav-item d-flex"><a class="text-white text-center w-100" data-toggle="modal" data-target="#login" href="#">Connexion</a></li>
                                <li class="nav-item d-flex"><a class="text-white text-center w-100" href="MU-x.html">Mon profil</a></li>
                                <li class="nav-item d-flex"><a class="text-white text-center w-100" href="MU-x.html">Mes listes</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>   
