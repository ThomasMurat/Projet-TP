        ...
        <form class="offset-1 col-10" action="index.php?universe=<?= $universe ?>&content=subscrib" method="POST" enctype="multipart/form-data" class="w-100">
            ...
            <div id="subscribFormContent" class="row">
                <div class="form-group col-12">
                    ...
                    <p class="text-danger"><?= (!empty($subscribFormErrors['username'])) ? $subscribFormErrors['username'] : '' ;?></p>
                </div>
                <div class="form-group col-12">
                    <label for="file">Image Profile :</label>
                    <input onblur="checkFieldValidity(this);" class="form-control" type="file" name="file" id="file" />
                ...
                <div class="form-group col-12">
                    ...
                    <p class="text-danger"><?= (!empty($subscribFormErrors['mail'])) ? $subscribFormErrors['mail'] : '' ;?></p>
                </div>
                <div class="form-group col-12">
                    <label for="mailConfirm">Confirmer adresse e-mail :</label>
                    <input  onblur="checkFieldValidity(this);" type="email" class="form-control <?=(isset($_POST['postSubscribe'])) ? (!empty($subscribFormErrors['mailConfirm']))? 'is-invalid' : 'is-valid'  : '' ; ?>" id="mailConfirm" name="mailConfirm" />
                ...
                <div class="form-group col-12">
                    ...
                    <input onblur="checkFieldValidity(this);" type="password" class="form-control <?=(isset($_POST['postSubscribe'])) ? (!empty($subscribFormErrors['passwordConfirm']))? 'is-invalid' : 'is-valid'  : '' ; ?>" id="passwordConfirm" name="passwordConfirm" />
