...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 22 août 2020 à 13:54
...
--
-- Structure de la table `42pmz96_listehaveproducts`
--

DROP TABLE IF EXISTS `42pmz96_listehaveproducts`;
CREATE TABLE IF NOT EXISTS `42pmz96_listehaveproducts` (
  `id` int(11) NOT NULL,
  `id_42pmz96_products` int(11) NOT NULL,
  PRIMARY KEY (`id`,`id_42pmz96_products`),
  KEY `42pmz96_listeHaveProducts_42pmz96_products0_FK` (`id_42pmz96_products`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
-- Structure de la table `42pmz96_productshaveproducers`
--

DROP TABLE IF EXISTS `42pmz96_productshaveproducers`;
CREATE TABLE IF NOT EXISTS `42pmz96_productshaveproducers` (
  `id` int(11) NOT NULL,
  `id_42pmz96_products` int(11) NOT NULL,
  PRIMARY KEY (`id`,`id_42pmz96_products`),
  KEY `42pmz96_productsHaveProducers_42pmz96_products0_FK` (`id_42pmz96_products`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(6, 'test', '$2y$10$I1VwApaKWcQ3FteTZcf5p.yosYXFnOMT.rbgnoplHGw2CVMo.PrdK', 'test@hotmail.fr', '2000-03-10', '2020-08-14 16:14:48', 2);
...
--
-- Contraintes pour la table `42pmz96_listehaveproducts`
--
ALTER TABLE `42pmz96_listehaveproducts`
  ADD CONSTRAINT `42pmz96_listeHaveProducts_42pmz96_listes_FK` FOREIGN KEY (`id`) REFERENCES `42pmz96_listes` (`id`),
  ADD CONSTRAINT `42pmz96_listeHaveProducts_42pmz96_products0_FK` FOREIGN KEY (`id_42pmz96_products`) REFERENCES `42pmz96_products` (`id`);
...
--
-- Contraintes pour la table `42pmz96_productshaveproducers`
--
ALTER TABLE `42pmz96_productshaveproducers`
  ADD CONSTRAINT `42pmz96_productsHaveProducers_42pmz96_producers_FK` FOREIGN KEY (`id`) REFERENCES `42pmz96_producers` (`id`),
  ADD CONSTRAINT `42pmz96_productsHaveProducers_42pmz96_products0_FK` FOREIGN KEY (`id_42pmz96_products`) REFERENCES `42pmz96_products` (`id`);
